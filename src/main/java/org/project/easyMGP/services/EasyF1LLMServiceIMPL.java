package org.project.easyMGP.services;
...
public class EasyF1LLMServiceIMPL implements LLMService {
    ...
    private EasyMGPLiveSessionClient liveSessionClient;

    @Value("${spring.ai.vertex.ai.gemini.credentials-uri}")
    private String apiKey;

    public EasyF1LLMServiceIMPL(MeetingRepository meetingRepository, EasyMGPLiveSessionClient liveSessionClient) {
