...
import org.project.easyMGP.client.EasyMGPMeetingProvider;
import org.project.easyMGP.client.EasyMGPSessionProvider;
...
public class MeetingInitializer {
    ...
    private EasyMGPMeetingProvider meetingClient;

    private EasyMGPSessionProvider sessionClient;

    private LLMService llmService;

    public MeetingInitializer(MeetingRepository meetingRepository, SessionRepository sessionRepository, EasyMGPMeetingProvider meetingClient, EasyMGPSessionProvider sessionClient,  LLMService llmService) {
