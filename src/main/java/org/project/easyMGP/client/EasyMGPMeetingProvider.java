...
@Component
public class EasyMGPMeetingProvider implements MeetingProvider {

    private final InnerEasyMGPMeetingClient client;

    @Autowired
    public EasyMGPMeetingProvider(InnerEasyMGPMeetingClient client) {
        this.client = client;
    }
    ...
    interface InnerEasyMGPMeetingClient {
        @GetMapping
