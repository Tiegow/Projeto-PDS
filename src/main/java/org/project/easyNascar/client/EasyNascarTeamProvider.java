...
public class EasyNascarTeamProvider implements TeamProvider{

    private final InnerEasyNascarTeamClient client;

    @Autowired
    public EasyNascarTeamProvider(InnerEasyNascarTeamClient client) {
        this.client = client;
    }
    ...
    interface InnerEasyNascarTeamClient {
